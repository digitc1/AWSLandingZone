...
#   --------------------------------------------------------
#
#       Landing Zone inventory Generator
...
update() {
    ...
    echo "" 
    echo "#######"
    echo "####### AWS Landing Zone Inventory Generator script environment configuration"
...
echo ""
echo "####### Environment is in good shape. Starting execution..."
echo "#######"
echo ""

params="-a $account"

python3 ./EC-Inventory-LZ.py $params
