...
#    Master_account=`aws organizations list-accounts --output text --query "Accounts[?Id=='$Master_accountId'][Name]"`
    ...
    echo "---------------------------------------------------------------------------------------------------------"
    echo "|                                                                                                       |"
    echo "|  This script has been deprecated. Please follow the instructions to create an AWS account depicted on |"
    echo "|  the following link                                                                                   |"
    echo "|                                                                                                       |"
    echo "|  https://webgate.ec.europa.eu/fpfis/wikis/display/CVTF/%5BAWS%5D+Account+creation+broker+procedure    |"
    echo "|                                                                                                       |"
    echo "---------------------------------------------------------------------------------------------------------"
